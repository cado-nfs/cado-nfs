...
/* *io::code_for_cxx_out */
std::ostream& mpfq_u64k2_cxx_out(mpfq_u64k2_dst_field k, std::ostream& os, mpfq_u64k2_src_elt x)
{
    char *str;
...
/* *io::code_for_cxx_in */
std::istream& mpfq_u64k2_cxx_in(mpfq_u64k2_dst_field k, std::istream& is, mpfq_u64k2_dst_elt z)
{
    char *tmp;
    int allocated, len=0;
    int start=0;
...
std::ostream& mpfq_u64k2_vec_cxx_out(mpfq_u64k2_dst_field K MAYBE_UNUSED, std::ostream& os, mpfq_u64k2_src_vec w, unsigned long n)
{
    char *str;
...
std::istream& mpfq_u64k2_vec_cxx_in(mpfq_u64k2_dst_field K MAYBE_UNUSED, std::istream& is, mpfq_u64k2_vec * w, unsigned long * n)
{
    char *tmp;
    char c;
    int allocated, len=0;
