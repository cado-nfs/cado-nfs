...
std::ostream& mpfq_u64k4_vec_cxx_out(mpfq_u64k4_dst_field K MAYBE_UNUSED, std::ostream& os, mpfq_u64k4_src_vec w, unsigned int n)
{
    char *str;
...
std::istream& mpfq_u64k4_vec_cxx_in(mpfq_u64k4_dst_field K MAYBE_UNUSED, std::istream& is, mpfq_u64k4_vec * w, unsigned int * n)
{
    char *tmp;
    char c;
    int allocated, len=0;
