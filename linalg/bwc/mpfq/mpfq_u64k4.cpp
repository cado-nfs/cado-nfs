...
/* *io::code_for_cxx_out */
std::ostream& mpfq_u64k4_cxx_out(mpfq_u64k4_dst_field k, std::ostream& os, mpfq_u64k4_src_elt x)
{
    char *str;
...
/* *io::code_for_cxx_in */
std::istream& mpfq_u64k4_cxx_in(mpfq_u64k4_dst_field k, std::istream& is, mpfq_u64k4_dst_elt z)
{
    char *tmp;
    int allocated, len=0;
    int start=0;
...
std::ostream& mpfq_u64k4_vec_cxx_out(mpfq_u64k4_dst_field K MAYBE_UNUSED, std::ostream& os, mpfq_u64k4_src_vec w, unsigned long n)
{
    char *str;
...
std::istream& mpfq_u64k4_vec_cxx_in(mpfq_u64k4_dst_field K MAYBE_UNUSED, std::istream& is, mpfq_u64k4_vec * w, unsigned long * n)
{
    char *tmp;
    char c;
    int allocated, len=0;
