#ifndef MPFQ_P_11_HPP_
#define MPFQ_P_11_HPP_
...
std::ostream& mpfq_p_11_cxx_out(mpfq_p_11_dst_field, std::ostream&, mpfq_p_11_src_elt);
std::istream& mpfq_p_11_cxx_in(mpfq_p_11_dst_field, std::istream&, mpfq_p_11_dst_elt);

/* Vector functions */
std::ostream& mpfq_p_11_vec_cxx_out(mpfq_p_11_dst_field, std::ostream&, mpfq_p_11_src_vec, unsigned long);
std::istream& mpfq_p_11_vec_cxx_in(mpfq_p_11_dst_field, std::istream&, mpfq_p_11_vec *, unsigned long *);

/* Polynomial functions */
/* *Mpfq::defaults::poly::code_for_poly_cxx_out, Mpfq::gfp */
static inline
std::ostream& mpfq_p_11_poly_cxx_out(mpfq_p_11_dst_field k MAYBE_UNUSED, std::ostream& os, mpfq_p_11_src_poly w)
{
    return mpfq_p_11_vec_cxx_out(k, os, w->c, w->size);
}

/* *Mpfq::defaults::poly::code_for_poly_cxx_in, Mpfq::gfp */
static inline
std::istream& mpfq_p_11_poly_cxx_in(mpfq_p_11_dst_field k MAYBE_UNUSED, std::istream& is, mpfq_p_11_dst_poly w)
{
    mpfq_p_11_vec_cxx_in(k, is, &(w->c), &(w->alloc));
    w->size = w->alloc;
    return is;
}
