...
std::ostream& mpfq_p_13_vec_cxx_out(mpfq_p_13_dst_field K MAYBE_UNUSED, std::ostream& os, mpfq_p_13_src_vec w, unsigned int n)
{
    char *str;
...
std::istream& mpfq_p_13_vec_cxx_in(mpfq_p_13_dst_field K MAYBE_UNUSED, std::istream& is, mpfq_p_13_vec * w, unsigned int * n)
{
    char *tmp;
    char c;
    int allocated, len=0;
