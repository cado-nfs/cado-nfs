#ifndef MPFQ_P_15_HPP_
#define MPFQ_P_15_HPP_
...
std::ostream& mpfq_p_15_cxx_out(mpfq_p_15_dst_field, std::ostream&, mpfq_p_15_src_elt);
...
static inline
std::ostream& mpfq_p_15_poly_cxx_out(mpfq_p_15_dst_field k MAYBE_UNUSED, std::ostream& os, mpfq_p_15_src_poly w)
{
    return mpfq_p_15_vec_cxx_out(k, os, w->c, w->size);
}

/* *Mpfq::defaults::poly::code_for_poly_cxx_in, Mpfq::gfp */
static inline
std::istream& mpfq_p_15_poly_cxx_in(mpfq_p_15_dst_field k MAYBE_UNUSED, std::istream& is, mpfq_p_15_dst_poly w)
{
    mpfq_p_15_vec_cxx_in(k, is, &(w->c), &(w->alloc));
    w->size = w->alloc;
    return is;
}
