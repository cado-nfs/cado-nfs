...
/* Vector functions */
std::ostream& mpfq_p_6_vec_cxx_out(mpfq_p_6_dst_field, std::ostream&, mpfq_p_6_src_vec, unsigned int);
std::istream& mpfq_p_6_vec_cxx_in(mpfq_p_6_dst_field, std::istream&, mpfq_p_6_vec *, unsigned int *);
