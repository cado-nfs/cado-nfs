...
std::ostream& mpfq_p_12_cxx_out(mpfq_p_12_dst_field k, std::ostream& os, mpfq_p_12_src_elt x)
{
    char *str;
...
std::istream& mpfq_p_12_cxx_in(mpfq_p_12_dst_field k, std::istream& is, mpfq_p_12_dst_elt z)
{
    char *tmp;
    int allocated, len=0;
    int start=0;
...
std::ostream& mpfq_p_12_vec_cxx_out(mpfq_p_12_dst_field K MAYBE_UNUSED, std::ostream& os, mpfq_p_12_src_vec w, unsigned long n)
{
    char *str;
...
std::istream& mpfq_p_12_vec_cxx_in(mpfq_p_12_dst_field K MAYBE_UNUSED, std::istream& is, mpfq_p_12_vec * w, unsigned long * n)
{
    char *tmp;
    char c;
    int allocated, len=0;
