...
std::ostream& mpfq_p_10_cxx_out(mpfq_p_10_dst_field k, std::ostream& os, mpfq_p_10_src_elt x)
{
    char *str;
...
std::istream& mpfq_p_10_cxx_in(mpfq_p_10_dst_field k, std::istream& is, mpfq_p_10_dst_elt z)
{
    char *tmp;
    int allocated, len=0;
    int start=0;
