...
/* Vector functions */
std::ostream& mpfq_pz_vec_cxx_out(mpfq_pz_dst_field, std::ostream&, mpfq_pz_src_vec, unsigned int);
std::istream& mpfq_pz_vec_cxx_in(mpfq_pz_dst_field, std::istream&, mpfq_pz_vec *, unsigned int *);
