...
/* Vector functions */
std::ostream& mpfq_p_14_vec_cxx_out(mpfq_p_14_dst_field, std::ostream&, mpfq_p_14_src_vec, unsigned int);
std::istream& mpfq_p_14_vec_cxx_in(mpfq_p_14_dst_field, std::istream&, mpfq_p_14_vec *, unsigned int *);
