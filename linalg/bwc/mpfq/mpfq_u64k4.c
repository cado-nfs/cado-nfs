...
mpz_srcptr mpfq_u64k4_field_characteristic_srcptr(mpfq_u64k4_src_field K MAYBE_UNUSED)
{
        /* yes, this is ugly */
...
void mpfq_u64k4_vec_init(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec * v, unsigned long n)
{
    unsigned int i;
...
void mpfq_u64k4_vec_reinit(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec * v, unsigned long n, unsigned long m)
{
...
void mpfq_u64k4_vec_clear(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec * v, unsigned long n)
{
        unsigned int i;
    for(i = 0; i < n; i+=1)
        mpfq_u64k4_clear(K, (*v) + i);
...
void mpfq_u64k4_vec_random(mpfq_u64k4_dst_field k, mpfq_u64k4_dst_vec w, unsigned long n, gmp_randstate_t state)
{
...
void mpfq_u64k4_vec_random2(mpfq_u64k4_dst_field k, mpfq_u64k4_dst_vec w, unsigned long n, gmp_randstate_t state)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_u64k4_dst_elt x = mpfq_u64k4_vec_coeff_ptr(k, w, i);
...
long mpfq_u64k4_vec_cmp(mpfq_u64k4_dst_field k, mpfq_u64k4_src_vec u, mpfq_u64k4_src_vec v, unsigned long n)
{
        for (unsigned int i = 0; i < n; ++i) {
...
long mpfq_u64k4_vec_is_zero(mpfq_u64k4_dst_field k, mpfq_u64k4_src_vec v, unsigned long n)
{
        for (unsigned int i = 0; i < n; ++i) {
...
long mpfq_u64k4_vec_asprint(mpfq_u64k4_dst_field K MAYBE_UNUSED, char * * pstr, mpfq_u64k4_src_vec w, unsigned long n)
{
    if (n == 0) {
...
long mpfq_u64k4_vec_fprint(mpfq_u64k4_dst_field K MAYBE_UNUSED, FILE * file, mpfq_u64k4_src_vec w, unsigned long n)
{
    char *str;
    int rc;
...
long mpfq_u64k4_vec_print(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_src_vec w, unsigned long n)
{
    return mpfq_u64k4_vec_fprint(K,stdout,w,n);
}

/* *Mpfq::defaults::vec::io::code_for_vec_sscan, Mpfq::defaults::vec */
long mpfq_u64k4_vec_sscan(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec * w, unsigned long * n, const char * str)
{
...
long mpfq_u64k4_vec_fscan(mpfq_u64k4_dst_field K MAYBE_UNUSED, FILE * file, mpfq_u64k4_vec * w, unsigned long * n)
{
    char *tmp;
    int c;
    int allocated, len=0;
...
long mpfq_u64k4_vec_hamming_weight(mpfq_u64k4_dst_field k, mpfq_u64k4_src_vec v, unsigned long n)
{
        int w = 0;
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_u64k4_src_elt x = mpfq_u64k4_vec_coeff_ptr_const(k, v, i);
...
long mpfq_u64k4_vec_find_first_set(mpfq_u64k4_dst_field k, mpfq_u64k4_src_vec v, unsigned long n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_u64k4_src_elt x = mpfq_u64k4_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_u64k4_is_zero(k, x))
...
long mpfq_u64k4_vec_simd_hamming_weight(mpfq_u64k4_dst_field k, mpfq_u64k4_src_vec v, unsigned long n)
{
        int w = 0;
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_u64k4_src_elt x = mpfq_u64k4_vec_coeff_ptr_const(k, v, i);
...
long mpfq_u64k4_vec_simd_find_first_set(mpfq_u64k4_dst_field k, mpfq_u64k4_src_vec v, unsigned long n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_u64k4_src_elt x = mpfq_u64k4_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_u64k4_is_zero(k, x))
...
void mpfq_u64k4_vec_ur_init(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec_ur * v, unsigned long n)
{
    unsigned int i;
...
void mpfq_u64k4_vec_ur_reinit(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec_ur * v, unsigned long n, unsigned long m)
{
    if (n < m) { // increase size
...
void mpfq_u64k4_vec_ur_clear(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_vec_ur * v, unsigned long n)
{
    unsigned int i;
    for(i = 0; i < n; i+=1)
        mpfq_u64k4_elt_ur_clear(K, &( (*v)[i]));
...
static ptrdiff_t mpfq_u64k4_wrapper_vec_ur_elt_stride(mpfq_vbase_ptr, long);
static ptrdiff_t mpfq_u64k4_wrapper_vec_ur_elt_stride(mpfq_vbase_ptr vbase MAYBE_UNUSED, long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_ur_elt_stride(vbase->obj, n);
}

static ptrdiff_t mpfq_u64k4_wrapper_vec_elt_stride(mpfq_vbase_ptr, long);
static ptrdiff_t mpfq_u64k4_wrapper_vec_elt_stride(mpfq_vbase_ptr vbase MAYBE_UNUSED, long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_elt_stride(vbase->obj, n);
}

static mpfq_u64k4_src_elt mpfq_u64k4_wrapper_vec_ur_coeff_ptr_const(mpfq_vbase_ptr, mpfq_u64k4_src_vec_ur, long);
static mpfq_u64k4_src_elt mpfq_u64k4_wrapper_vec_ur_coeff_ptr_const(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec_ur v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_ur_coeff_ptr_const(vbase->obj, v, i);
}

static mpfq_u64k4_dst_elt mpfq_u64k4_wrapper_vec_ur_coeff_ptr(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, long);
static mpfq_u64k4_dst_elt mpfq_u64k4_wrapper_vec_ur_coeff_ptr(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_ur_coeff_ptr(vbase->obj, v, i);
}

static mpfq_u64k4_src_vec_ur mpfq_u64k4_wrapper_vec_ur_subvec_const(mpfq_vbase_ptr, mpfq_u64k4_src_vec_ur, long);
static mpfq_u64k4_src_vec_ur mpfq_u64k4_wrapper_vec_ur_subvec_const(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec_ur v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_ur_subvec_const(vbase->obj, v, i);
}

static mpfq_u64k4_dst_vec_ur mpfq_u64k4_wrapper_vec_ur_subvec(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, long);
static mpfq_u64k4_dst_vec_ur mpfq_u64k4_wrapper_vec_ur_subvec(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_ur_subvec(vbase->obj, v, i);
}

static void mpfq_u64k4_wrapper_vec_reduce(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_dst_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_reduce(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur u MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_reduce(vbase->obj, w, u, n);
}

static void mpfq_u64k4_wrapper_vec_scal_mul_ur(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec, mpfq_u64k4_src_elt, unsigned long);
static void mpfq_u64k4_wrapper_vec_scal_mul_ur(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, mpfq_u64k4_src_elt c MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_scal_mul_ur(vbase->obj, w, u, c, n);
}

static void mpfq_u64k4_wrapper_vec_ur_rev(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_rev(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_vec_ur u MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_rev(vbase->obj, w, u, n);
}

static void mpfq_u64k4_wrapper_vec_ur_neg(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_neg(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_vec_ur u MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_neg(vbase->obj, w, u, n);
}

static void mpfq_u64k4_wrapper_vec_ur_sub(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec_ur, mpfq_u64k4_src_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_sub(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_vec_ur u MAYBE_UNUSED, mpfq_u64k4_src_vec_ur v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_sub(vbase->obj, w, u, v, n);
}

static void mpfq_u64k4_wrapper_vec_ur_add(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec_ur, mpfq_u64k4_src_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_add(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_vec_ur u MAYBE_UNUSED, mpfq_u64k4_src_vec_ur v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_add(vbase->obj, w, u, v, n);
}

static void mpfq_u64k4_wrapper_vec_ur_getcoeff(mpfq_vbase_ptr, mpfq_u64k4_dst_elt_ur, mpfq_u64k4_src_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_getcoeff(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_elt_ur x MAYBE_UNUSED, mpfq_u64k4_src_vec_ur w MAYBE_UNUSED, unsigned long i MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_getcoeff(vbase->obj, x, w, i);
}

static void mpfq_u64k4_wrapper_vec_ur_setcoeff(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_elt_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_setcoeff(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_elt_ur x MAYBE_UNUSED, unsigned long i MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_setcoeff(vbase->obj, w, x, i);
}

static void mpfq_u64k4_wrapper_vec_ur_set(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur r MAYBE_UNUSED, mpfq_u64k4_src_vec_ur s MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_set(vbase->obj, r, s, n);
}

static void mpfq_u64k4_wrapper_vec_ur_clear(mpfq_vbase_ptr, mpfq_u64k4_vec_ur *, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_clear(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec_ur * v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_clear(vbase->obj, v, n);
}

static void mpfq_u64k4_wrapper_vec_ur_reinit(mpfq_vbase_ptr, mpfq_u64k4_vec_ur *, unsigned long, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_reinit(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec_ur * v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED, unsigned long m MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_reinit(vbase->obj, v, n, m);
}

static void mpfq_u64k4_wrapper_vec_ur_set_vec(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_set_vec(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_set_vec(vbase->obj, w, u, n);
}

static void mpfq_u64k4_wrapper_vec_ur_set_zero(mpfq_vbase_ptr, mpfq_u64k4_dst_vec_ur, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_set_zero(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur r MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_set_zero(vbase->obj, r, n);
}

static void mpfq_u64k4_wrapper_vec_ur_init(mpfq_vbase_ptr, mpfq_u64k4_vec_ur *, unsigned long);
static void mpfq_u64k4_wrapper_vec_ur_init(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec_ur * v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_ur_init(vbase->obj, v, n);
}

static long mpfq_u64k4_wrapper_vec_simd_find_first_set(mpfq_vbase_ptr, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_simd_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_simd_find_first_set(vbase->obj, v, n);
}

static long mpfq_u64k4_wrapper_vec_simd_hamming_weight(mpfq_vbase_ptr, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_simd_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_simd_hamming_weight(vbase->obj, v, n);
}

static long mpfq_u64k4_wrapper_vec_find_first_set(mpfq_vbase_ptr, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_find_first_set(vbase->obj, v, n);
}

static long mpfq_u64k4_wrapper_vec_hamming_weight(mpfq_vbase_ptr, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_hamming_weight(vbase->obj, v, n);
}

static long mpfq_u64k4_wrapper_vec_scan(mpfq_vbase_ptr, mpfq_u64k4_vec *, unsigned long *);
static long mpfq_u64k4_wrapper_vec_scan(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec * w MAYBE_UNUSED, unsigned long * n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_scan(vbase->obj, w, n);
}

static long mpfq_u64k4_wrapper_vec_fscan(mpfq_vbase_ptr, FILE *, mpfq_u64k4_vec *, unsigned long *);
static long mpfq_u64k4_wrapper_vec_fscan(mpfq_vbase_ptr vbase MAYBE_UNUSED, FILE * file MAYBE_UNUSED, mpfq_u64k4_vec * w MAYBE_UNUSED, unsigned long * n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_fscan(vbase->obj, file, w, n);
}

static long mpfq_u64k4_wrapper_vec_sscan(mpfq_vbase_ptr, mpfq_u64k4_vec *, unsigned long *, const char *);
static long mpfq_u64k4_wrapper_vec_sscan(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec * w MAYBE_UNUSED, unsigned long * n MAYBE_UNUSED, const char * str MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_sscan(vbase->obj, w, n, str);
}

static long mpfq_u64k4_wrapper_vec_print(mpfq_vbase_ptr, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_print(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec w MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_print(vbase->obj, w, n);
}

static long mpfq_u64k4_wrapper_vec_fprint(mpfq_vbase_ptr, FILE *, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_fprint(mpfq_vbase_ptr vbase MAYBE_UNUSED, FILE * file MAYBE_UNUSED, mpfq_u64k4_src_vec w MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_fprint(vbase->obj, file, w, n);
}

static long mpfq_u64k4_wrapper_vec_asprint(mpfq_vbase_ptr, char * *, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_asprint(mpfq_vbase_ptr vbase MAYBE_UNUSED, char * * pstr MAYBE_UNUSED, mpfq_u64k4_src_vec w MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_asprint(vbase->obj, pstr, w, n);
}

static mpfq_u64k4_src_elt mpfq_u64k4_wrapper_vec_coeff_ptr_const(mpfq_vbase_ptr, mpfq_u64k4_src_vec, long);
static mpfq_u64k4_src_elt mpfq_u64k4_wrapper_vec_coeff_ptr_const(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_coeff_ptr_const(vbase->obj, v, i);
}

static mpfq_u64k4_dst_elt mpfq_u64k4_wrapper_vec_coeff_ptr(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, long);
static mpfq_u64k4_dst_elt mpfq_u64k4_wrapper_vec_coeff_ptr(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_coeff_ptr(vbase->obj, v, i);
}

static mpfq_u64k4_src_vec mpfq_u64k4_wrapper_vec_subvec_const(mpfq_vbase_ptr, mpfq_u64k4_src_vec, long);
static mpfq_u64k4_src_vec mpfq_u64k4_wrapper_vec_subvec_const(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_subvec_const(vbase->obj, v, i);
}

static mpfq_u64k4_dst_vec mpfq_u64k4_wrapper_vec_subvec(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, long);
static mpfq_u64k4_dst_vec mpfq_u64k4_wrapper_vec_subvec(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec v MAYBE_UNUSED, long i MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_subvec(vbase->obj, v, i);
}

static long mpfq_u64k4_wrapper_vec_is_zero(mpfq_vbase_ptr, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_is_zero(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_is_zero(vbase->obj, v, n);
}

static long mpfq_u64k4_wrapper_vec_cmp(mpfq_vbase_ptr, mpfq_u64k4_src_vec, mpfq_u64k4_src_vec, unsigned long);
static long mpfq_u64k4_wrapper_vec_cmp(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    return mpfq_u64k4_vec_cmp(vbase->obj, u, v, n);
}

static void mpfq_u64k4_wrapper_vec_random2(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, unsigned long, gmp_randstate_t);
static void mpfq_u64k4_wrapper_vec_random2(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, unsigned long n MAYBE_UNUSED, gmp_randstate_t state MAYBE_UNUSED)
{
    mpfq_u64k4_vec_random2(vbase->obj, w, n, state);
}

static void mpfq_u64k4_wrapper_vec_random(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, unsigned long, gmp_randstate_t);
static void mpfq_u64k4_wrapper_vec_random(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, unsigned long n MAYBE_UNUSED, gmp_randstate_t state MAYBE_UNUSED)
{
    mpfq_u64k4_vec_random(vbase->obj, w, n, state);
}

static void mpfq_u64k4_wrapper_vec_scal_mul(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, mpfq_u64k4_src_elt, unsigned long);
static void mpfq_u64k4_wrapper_vec_scal_mul(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, mpfq_u64k4_src_elt c MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_scal_mul(vbase->obj, w, u, c, n);
}

static void mpfq_u64k4_wrapper_vec_sub(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_sub(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_sub(vbase->obj, w, u, v, n);
}

static void mpfq_u64k4_wrapper_vec_rev(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_rev(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_rev(vbase->obj, w, u, n);
}

static void mpfq_u64k4_wrapper_vec_neg(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_neg(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_neg(vbase->obj, w, u, n);
}

static void mpfq_u64k4_wrapper_vec_add(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_add(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_src_vec u MAYBE_UNUSED, mpfq_u64k4_src_vec v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_add(vbase->obj, w, u, v, n);
}

static void mpfq_u64k4_wrapper_vec_getcoeff(mpfq_vbase_ptr, mpfq_u64k4_dst_elt, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_getcoeff(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_elt x MAYBE_UNUSED, mpfq_u64k4_src_vec w MAYBE_UNUSED, unsigned long i MAYBE_UNUSED)
{
    mpfq_u64k4_vec_getcoeff(vbase->obj, x, w, i);
}

static void mpfq_u64k4_wrapper_vec_setcoeff(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_elt, unsigned long);
static void mpfq_u64k4_wrapper_vec_setcoeff(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec w MAYBE_UNUSED, mpfq_u64k4_src_elt x MAYBE_UNUSED, unsigned long i MAYBE_UNUSED)
{
    mpfq_u64k4_vec_setcoeff(vbase->obj, w, x, i);
}

static void mpfq_u64k4_wrapper_vec_set_zero(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_set_zero(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec r MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_set_zero(vbase->obj, r, n);
}

static void mpfq_u64k4_wrapper_vec_set(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, unsigned long);
static void mpfq_u64k4_wrapper_vec_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec r MAYBE_UNUSED, mpfq_u64k4_src_vec s MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_set(vbase->obj, r, s, n);
}

static void mpfq_u64k4_wrapper_vec_clear(mpfq_vbase_ptr, mpfq_u64k4_vec *, unsigned long);
static void mpfq_u64k4_wrapper_vec_clear(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec * v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
    mpfq_u64k4_vec_clear(vbase->obj, v, n);
}

static void mpfq_u64k4_wrapper_vec_reinit(mpfq_vbase_ptr, mpfq_u64k4_vec *, unsigned long, unsigned long);
static void mpfq_u64k4_wrapper_vec_reinit(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec * v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED, unsigned long m MAYBE_UNUSED)
{
    mpfq_u64k4_vec_reinit(vbase->obj, v, n, m);
}

static void mpfq_u64k4_wrapper_vec_init(mpfq_vbase_ptr, mpfq_u64k4_vec *, unsigned long);
static void mpfq_u64k4_wrapper_vec_init(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_vec * v MAYBE_UNUSED, unsigned long n MAYBE_UNUSED)
{
...
static mpz_srcptr mpfq_u64k4_wrapper_field_characteristic_srcptr(mpfq_vbase_ptr);
static mpz_srcptr mpfq_u64k4_wrapper_field_characteristic_srcptr(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_u64k4_field_characteristic_srcptr(vbase->obj);
}
...
void mpfq_u64k4_oo_field_init(mpfq_vbase_ptr vbase)
{
    ...
    vbase->field_characteristic_srcptr = (mpz_srcptr (*) (mpfq_vbase_ptr)) mpfq_u64k4_wrapper_field_characteristic_srcptr;
    ...
    /* missing write */
    /* missing exportdata */
    vbase->vec_init = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_u64k4_wrapper_vec_init;
    vbase->vec_reinit = (void (*) (mpfq_vbase_ptr, void *, unsigned long, unsigned long)) mpfq_u64k4_wrapper_vec_reinit;
    vbase->vec_clear = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_u64k4_wrapper_vec_clear;
    vbase->vec_set = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_set;
    vbase->vec_set_zero = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_u64k4_wrapper_vec_set_zero;
    vbase->vec_setcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_setcoeff;
    /* missing vec_setcoeff_ui */
    vbase->vec_getcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_getcoeff;
    vbase->vec_add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_add;
    vbase->vec_neg = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_neg;
    vbase->vec_rev = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_rev;
    vbase->vec_sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_sub;
    vbase->vec_scal_mul = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_scal_mul;
    /* missing vec_conv */
    vbase->vec_random = (void (*) (mpfq_vbase_ptr, void *, unsigned long, gmp_randstate_t)) mpfq_u64k4_wrapper_vec_random;
    vbase->vec_random2 = (void (*) (mpfq_vbase_ptr, void *, unsigned long, gmp_randstate_t)) mpfq_u64k4_wrapper_vec_random2;
    vbase->vec_cmp = (long (*) (mpfq_vbase_ptr, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_cmp;
    vbase->vec_is_zero = (long (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_is_zero;
    vbase->vec_subvec = (void * (*) (mpfq_vbase_ptr, void *, long)) mpfq_u64k4_wrapper_vec_subvec;
    vbase->vec_subvec_const = (const void * (*) (mpfq_vbase_ptr, const void *, long)) mpfq_u64k4_wrapper_vec_subvec_const;
    vbase->vec_coeff_ptr = (void * (*) (mpfq_vbase_ptr, void *, long)) mpfq_u64k4_wrapper_vec_coeff_ptr;
    vbase->vec_coeff_ptr_const = (const void * (*) (mpfq_vbase_ptr, const void *, long)) mpfq_u64k4_wrapper_vec_coeff_ptr_const;
    vbase->vec_asprint = (long (*) (mpfq_vbase_ptr, char * *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_asprint;
    vbase->vec_fprint = (long (*) (mpfq_vbase_ptr, FILE *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_fprint;
    vbase->vec_print = (long (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_print;
    vbase->vec_sscan = (long (*) (mpfq_vbase_ptr, void *, unsigned long *, const char *)) mpfq_u64k4_wrapper_vec_sscan;
    vbase->vec_fscan = (long (*) (mpfq_vbase_ptr, FILE *, void *, unsigned long *)) mpfq_u64k4_wrapper_vec_fscan;
    vbase->vec_scan = (long (*) (mpfq_vbase_ptr, void *, unsigned long *)) mpfq_u64k4_wrapper_vec_scan;
    /* missing vec_read */
    /* missing vec_write */
    /* missing vec_import */
    /* missing vec_export */
    vbase->vec_hamming_weight = (long (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_hamming_weight;
    vbase->vec_find_first_set = (long (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_find_first_set;
    vbase->vec_simd_hamming_weight = (long (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_simd_hamming_weight;
    vbase->vec_simd_find_first_set = (long (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_simd_find_first_set;
    vbase->vec_ur_init = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_init;
    vbase->vec_ur_set_zero = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_set_zero;
    vbase->vec_ur_set_vec = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_set_vec;
    vbase->vec_ur_reinit = (void (*) (mpfq_vbase_ptr, void *, unsigned long, unsigned long)) mpfq_u64k4_wrapper_vec_ur_reinit;
    vbase->vec_ur_clear = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_clear;
    vbase->vec_ur_set = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_set;
    vbase->vec_ur_setcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_setcoeff;
    vbase->vec_ur_getcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_getcoeff;
    vbase->vec_ur_add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_add;
    vbase->vec_ur_sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_sub;
    vbase->vec_ur_neg = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_neg;
    vbase->vec_ur_rev = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_ur_rev;
    vbase->vec_scal_mul_ur = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned long)) mpfq_u64k4_wrapper_vec_scal_mul_ur;
    /* missing vec_conv_ur */
    vbase->vec_reduce = (void (*) (mpfq_vbase_ptr, void *, void *, unsigned long)) mpfq_u64k4_wrapper_vec_reduce;
    vbase->vec_ur_subvec = (void * (*) (mpfq_vbase_ptr, void *, long)) mpfq_u64k4_wrapper_vec_ur_subvec;
    vbase->vec_ur_subvec_const = (const void * (*) (mpfq_vbase_ptr, const void *, long)) mpfq_u64k4_wrapper_vec_ur_subvec_const;
    vbase->vec_ur_coeff_ptr = (void * (*) (mpfq_vbase_ptr, void *, long)) mpfq_u64k4_wrapper_vec_ur_coeff_ptr;
    vbase->vec_ur_coeff_ptr_const = (const void * (*) (mpfq_vbase_ptr, const void *, long)) mpfq_u64k4_wrapper_vec_ur_coeff_ptr_const;
    vbase->vec_elt_stride = (ptrdiff_t (*) (mpfq_vbase_ptr, long)) mpfq_u64k4_wrapper_vec_elt_stride;
    vbase->vec_ur_elt_stride = (ptrdiff_t (*) (mpfq_vbase_ptr, long)) mpfq_u64k4_wrapper_vec_ur_elt_stride;
    /* missing poly_init */
    /* missing poly_clear */
    /* missing poly_set */
