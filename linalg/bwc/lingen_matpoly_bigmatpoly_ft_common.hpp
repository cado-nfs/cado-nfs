...
template<typename OP_CTX_T, typename OP_T> struct mp_or_mul { 
    ...
    mp_or_mul(OP_CTX_T & CTX, OP_T & OP,
        ...
        , shrink_split0(mpi_split0.block_size_upper_bound(), shrink0, matpoly::over_gf2 ? 64 : 1)
        , shrink_split2(mpi_split2.block_size_upper_bound(), shrink2, matpoly::over_gf2 ? 64 : 1)
