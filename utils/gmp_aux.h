...
CADO_INLINE void mpz_uint64_sub (mpz_ptr a, const uint64_t b, mpz_srcptr c) {
...
#else
CADO_INLINE void mpz_init_set_uint64 (mpz_ptr a, const uint64_t b) {mpz_init_set_ui(a, b);}
CADO_INLINE void mpz_init_set_int64 (mpz_ptr a, const int64_t b) {mpz_init_set_si(a, b);}
CADO_INLINE void mpz_set_uint64 (mpz_ptr a, const uint64_t b) {mpz_set_ui(a, b);}
CADO_INLINE void mpz_set_int64 (mpz_ptr a, const int64_t b) {mpz_set_si(a, b);}
CADO_INLINE uint64_t mpz_get_uint64 (mpz_srcptr a) {return (uint64_t) mpz_get_ui(a);}
CADO_INLINE uint64_t mpz_getlimbn_uint64 (mpz_srcptr z, unsigned int i) { return (uint64_t) mpz_getlimbn(z, i); }
CADO_INLINE int64_t mpz_get_int64 (mpz_srcptr a) {return (int64_t) mpz_get_si(a);}
CADO_INLINE void mpz_mul_uint64 (mpz_ptr a, mpz_srcptr b, const uint64_t c) {mpz_mul_ui(a, b, c);}
CADO_INLINE int mpz_cmp_uint64 (mpz_srcptr a, const uint64_t c) {return mpz_cmp_ui(a, c);}
CADO_INLINE int mpz_cmp_int64 (mpz_srcptr a, const int64_t c) {return mpz_cmp_si(a, c);}
CADO_INLINE void mpz_add_uint64 (mpz_ptr a, mpz_srcptr b, const uint64_t c) {mpz_add_ui(a, b, c);}
CADO_INLINE void mpz_add_int64 (mpz_ptr a, mpz_srcptr b, const int64_t c) {mpz_add_si(a, b, c);}
CADO_INLINE void mpz_sub_uint64 (mpz_ptr a, mpz_srcptr b, const uint64_t c) {mpz_sub_ui(a, b, c);}
CADO_INLINE void mpz_sub_int64 (mpz_ptr a, mpz_srcptr b, const int64_t c) {mpz_sub_si(a, b, c);}
CADO_INLINE void mpz_addmul_uint64 (mpz_ptr a, mpz_srcptr b, const uint64_t c) {mpz_addmul_ui(a, b, c);}
CADO_INLINE void mpz_submul_uint64 (mpz_ptr a, mpz_srcptr b, const uint64_t c) {mpz_submul_ui(a, b, c);}
CADO_INLINE void mpz_divexact_uint64 (mpz_ptr a, mpz_srcptr b, const uint64_t c) {mpz_divexact_ui(a, b, c);}
CADO_INLINE void mpz_mul_int64 (mpz_ptr a, mpz_srcptr b, const int64_t c) {mpz_mul_si(a, b, c);}
CADO_INLINE int mpz_fits_uint64_p(mpz_srcptr a) {return mpz_fits_ulong_p(a);}
CADO_INLINE int mpz_fits_sint64_p(mpz_srcptr a) {return mpz_fits_slong_p(a);}
CADO_INLINE int mpz_divisible_uint64_p (mpz_ptr a, const uint64_t c) {return mpz_divisible_ui_p(a, c);}
CADO_INLINE uint64_t uint64_nextprime (uint64_t a) {return (uint64_t) ulong_nextprime(a);}
CADO_INLINE void mpz_uint64_sub(mpz_ptr a, const uint64_t b, mpz_srcptr c) {mpz_ui_sub(a, b, c);}

CADO_INLINE uint64_t mpz_tdiv_qr_uint64 (mpz_ptr Q, mpz_ptr R, mpz_srcptr N, uint64_t d) {return mpz_tdiv_qr_ui(Q, R, N, d);}
CADO_INLINE uint64_t mpz_tdiv_q_uint64 (mpz_ptr Q, mpz_srcptr N, uint64_t d) {return mpz_tdiv_q_ui(Q, N, d);}
CADO_INLINE uint64_t mpz_tdiv_r_uint64 (mpz_ptr R, mpz_srcptr N, uint64_t d) {return mpz_tdiv_r_ui(R, N, d);}
CADO_INLINE uint64_t mpz_tdiv_uint64 (mpz_srcptr N, uint64_t d) {return mpz_tdiv_ui(N, d);}
CADO_INLINE uint64_t mpz_fdiv_qr_uint64 (mpz_ptr Q, mpz_ptr R, mpz_srcptr N, uint64_t d) {return mpz_fdiv_qr_ui(Q, R, N, d);}
CADO_INLINE uint64_t mpz_fdiv_q_uint64 (mpz_ptr Q, mpz_srcptr N, uint64_t d) {return mpz_fdiv_q_ui(Q, N, d);}
CADO_INLINE uint64_t mpz_fdiv_r_uint64 (mpz_ptr R, mpz_srcptr N, uint64_t d) {return mpz_fdiv_r_ui(R, N, d);}
CADO_INLINE uint64_t mpz_fdiv_uint64 (mpz_srcptr N, uint64_t d) {return mpz_fdiv_ui(N, d);}
#endif
...
CADO_INLINE void mpn_rrandom (mp_limb_t *rp, gmp_randstate_t rstate, mp_size_t N)
{
    mpz_t dummy;
    dummy->_mp_d = rp;
    dummy->_mp_alloc = N;
...
CADO_INLINE void mpn_randomb (mp_limb_t *rp, gmp_randstate_t rstate, mp_size_t N)
{
    mpz_t dummy;
    dummy->_mp_d = rp;
    dummy->_mp_alloc = N;
