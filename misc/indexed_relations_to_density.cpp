...
/* this is slow, because indexed_relation parsing is slow -- it was never
 * meant to be optimized in the first place, since the fast parsing is
 * done by filter_io instead. (I'm curious as to the reason of the slow
 * processing, though).
 *
