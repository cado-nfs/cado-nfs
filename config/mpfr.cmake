...
string(COMPARE NOTEQUAL "${MPFR_INCDIR}" MPFR_INCDIR-NOTFOUND MPFR_INCDIR_OK)
string(COMPARE NOTEQUAL "${MPFR_LIB}" MPFR_LIB-NOTFOUND MPFR_LIBDIR_OK)

get_filename_component(MPFR_LIBDIR ${MPFR_LIB} PATH)

if(MPFR_INCDIR_OK AND MPFR_LIBDIR_OK)
    set(WITH_MPFR 1 CACHE INTERNAL "MPFR is being used")
    set(HAVE_MPFR 1 CACHE INTERNAL "MPFR is being used")
else()
    message(STATUS "MPFR library cannot be found, some code will be disabled")
endif()
