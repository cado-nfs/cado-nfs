...
template <int LEVEL, typename HINT> class bucket_array_t : private NonCopyable
{
  ...
  private:
    ...
    void log_this_update(update_t const update, uint64_t bucket_number,
                         where_am_I & w) const;
  ...
  public:
    ...
    inline void push_update(int const bucket_number, update_t const & update,
                            where_am_I & w MAYBE_UNUSED);

    inline void push_row_update(slice_index_t slice_index, size_t increment,
