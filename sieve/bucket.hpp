...
/* This ATTR_ALIGNED() trick is somewhat unsatisfactory. I wish I could
 * find a better way. Maybe with alignas ? Is it a trick I can play at
 * template scope with CRTP or so ?
 *
