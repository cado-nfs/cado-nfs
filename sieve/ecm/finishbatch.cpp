...
static void declare_usage(param_list pl)
{
    ...
    param_list_decl_usage(pl, "lim1", "sieving bound on side 0");
    ...
    param_list_decl_usage(pl, "batchlpb1", "large prime bound on side 0 to be considered by batch cofactorization. Primes between lim0 and 2^batchlpb0 will be extracted by product trees. Defaults to lpb0.");
