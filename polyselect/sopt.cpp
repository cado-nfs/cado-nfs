...
{
  pl.declare_usage("inputpolys", "size-optimized the polynomials "
                                          "given in this file");
  {
      char * str;
  ...
  pl.declare_usage("translation-only", "(switch) do not use rotations");
...
int main (int argc, char const * argv[])
{
  ...
  pl.configure_switch_old("-translation-only", &use_only_translation);
  ...
  pl.parse("sopteffort", sopt_effort);
