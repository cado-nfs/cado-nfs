...
extern void polyselect_match_info_init(polyselect_match_info_ptr job, unsigned long p1, unsigned long p2, const int64_t i, uint64_t q, mpz_srcptr rq, polyselect_thread_locals_srcptr loc);

extern void polyselect_match_info_set(polyselect_match_info_ptr job, unsigned long p1, unsigned long p2, const int64_t i, uint64_t q, mpz_srcptr rq, polyselect_thread_locals_srcptr loc);
