...
test_compute_roots(bool verbose)
{
    ...
    /* A few roots of 2 */
    test_positive_roots<T>("x-2", 3, verbose,   {2}, -5);
    test_positive_roots<T>("x^2-2", 3, verbose, {1.4142135623730950488016887242096980786L}, -5);
    test_positive_roots<T>("x^3-2", 3, verbose, {1.2599210498948731647672106072782283506L}, -5);
    ...
    test_positive_roots<T>(
            ...
            1e20, verbose,
            {
            8694859813.27109836187832047186L,
            720776737597677797.826174347519L },
            -4);
}
