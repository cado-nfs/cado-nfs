#ifndef CADO_LAS_REDUCE_PLATTICE_MIMICK_PRODUCTION_NOASM_HPP
#define CADO_LAS_REDUCE_PLATTICE_MIMICK_PRODUCTION_NOASM_HPP
...
#endif	/* CADO_LAS_REDUCE_PLATTICE_MIMICK_PRODUCTION_NOASM_HPP */
